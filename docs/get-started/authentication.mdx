...
Note that when starting a Real-Time transcription session in the browser, you must provide the temporary key as a part of a query parameter. See our documentation on [browser based transcription](../rt-api-ref.mdx#browser-based-transcription).
