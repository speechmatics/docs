...
Your API key must be provided in the header of the [WebSocket connection request](/api-ref/agent-stt-websocket#handshake-responses) to the `/v2/agent` path. For example:
