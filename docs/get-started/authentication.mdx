...
| ------------- | ------ | ----------- | ----------------------------------------------------------------------------------------------------- |
| All     | N/A    | N/A         | **asr.api.speechmatics.com**                                                                          |
| All    | EU     | EU1         | **eu.asr.api.speechmatics.com**<br/>**eu1.asr.api.speechmatics.com**<br/>**asr.api.speechmatics.com** |
...
| Customer type | Region | Environment | Endpoints               |
| ------------- | ------ | ----------- | ----------------------- |
| All     | EU     | EU2         | eu2.rt.speechmatics.com |
