...
Make your first API call with the "Hello World" example in the [Speechmatics Academy](https://github.com/speechmatics/speechmatics-academy/tree/main/basics/01-hello-world).
