...
You can sign in with email and password, or with a connected OAuth account. Speechmatics supports Google and GitHub. Manage connected accounts under **[Settings > Profile > User](https://portal.speechmatics.com/settings/profile/user)**.
...
You cannot delete your account while you are an Admin in multiple workspaces. Transfer Admin access to another member first, or contact [support@speechmatics.com](mailto:support@speechmatics.com).
