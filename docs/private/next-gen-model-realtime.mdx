...
| Language hints                              | ⚠️        |
| `max_delay` / `max_delay_mode`              | ⚠️        |
| Mid-session config (`SetRecognitionConfig`) | ⚠️        |
| End of Utterance (EOU / FEOU)               | ⚠️        |
| Custom dictionary                           | ⚠️        |
| Alphanumerics (verbalised form only)        | ⚠️        |
| Entities / punctuation overrides            | ⚠️        |
| Disfluency removal                          | ⚠️        |
| Profanity tagging                           | ⚠️        |
| Audio volume filtering                      | ⚠️        |
| Translation                                 | ⚠️        |
| Audio events                                | ⚠️        |
