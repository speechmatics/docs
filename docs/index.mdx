...
import { ChevronsRightIcon, FileAudio, BotMessageSquare, MessagesSquare, Speech, Package } from "lucide-react";
...
<Grid columns={{initial: "1", md: "2"}} gap="3">
  ...
  <LinkCard
    icon={<MessagesSquare/>}
    title="Transcribe for a voice agent"
    description="Use Agent STT to get turn-based transcription ready to pass to an LLM"
    direction="column"
...
<Grid columns={{initial: "1", md: "2"}} gap="3">
  ...
  <LinkCard
    title="API reference"
    description="Explore our API reference. Available for: Realtime transcription, Batch transcription and Agent STT."
    href="/api-ref"
  />
</Grid>
