...
:::info
We will **never** send customer audio data over the network. See [What Data Do We Record](../../usage/what-data.mdx) for a full description of what information will be recorded.
:::
