...
The transcriber requires the appliance to be licensed before it can start, ensure the appliance is licensed, see [Licensing](./licensing/usage-and-licensing.mdx).
