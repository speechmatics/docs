---
sidebar_position: 1
description: Ensure your system is ready to run the appliance.
---
...
:::info **Note**
*VMware Workstation does not currently support PCI pastthrough, which is a requirement for running GPU transcription.
:::
...
Low IOPS can also result in longer startup times in for the appliance, in cases where the IOPS is too low the first few transcription request on a fresh VM may fail see [troubleshooting](/deployments/virtual-appliance/administration/services#troubleshooting).
...
For VMware, the document Performance Best Practices for VMware vSphere 7.0 contains a comprehensive overview of hardware considerations and recommendations on how to optimize your host platform. See [Broadcom support](https://support.broadcom.com) for up-to-date technical information on VMware.
