---
description: Set up the appliance's network configuration.
---
...
There is nothing to configure here. The network as specified during the import stage described in the [Download and Import](/deployments/virtual-appliance/installation/download-and-import) section will be used.
