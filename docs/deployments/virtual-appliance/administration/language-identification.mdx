---
description: Configure Language Identification on a Virtual Appliance deployment
---
...
You can learn more about Language Identification in the [SaaS documentation](/speech-to-text/pre-recorded/language-identification).
