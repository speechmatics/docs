...
> The sm-realtime chart is the recommended way of running Speechmatics containers for production environments.
  It provides a set of containers which will help protect and auto-scale sensitive websocket connections, and ensure performance with session capacity management. 
