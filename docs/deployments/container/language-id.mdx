...
:::tip
Looking for how to use this on SaaS on Cloud? See the documentation [here](/speech-to-text/pre-recorded/language-identification).
:::
...
A list of possible [Language Codes can be found here](/speech-to-text/languages). The following languages are not supported for Language Identification: Interlingua (ia), Esperanto (eo), Uyghur (ug), Cantonese (yue).
