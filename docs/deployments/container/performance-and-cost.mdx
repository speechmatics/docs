...
| Models                                    | [CPU Standard](./cpu-speech-to-text) | [CPU Enhanced](./cpu-speech-to-text) | [GPU Standard](./gpu-speech-to-text)      | [GPU Enhanced](./gpu-speech-to-text)      | [GPU Melia-1](./gpu-speech-to-text)        |
|-------------------------------------------|--------------------------------------|--------------------------------------|-------------------------------------------|-------------------------------------------|--------------------------------------------|
| Lowest Processing Cost (US ¢ per hour)    | 1.7                                  | 3.8                                  | 0.34                                      | 1.67                                      | 0.19                                       |
| Cost vs CPU Standard (%)                  | -                                    | 224%                                 | 20%                                       | 98%                                       | 11%                                        |
| Cost vs CPU Enhanced (%)                  | 45%                                  | -                                    | 9%                                        | 44%                                       | 5%                                         |
| Cost vs GPU Standard (%)                  | -                                    | -                                    | -                                         | -                                         | 56%                                        |
| Cost vs GPU Enhanced (%)                  | -                                    | -                                    | -                                         | -                                         | 11%                                        |
| Maximum Throughput[^1]                    | 53.2                                 | 23.7                                 | 350                                       | 45                                        | 3600                                       |
| Representative Real-Time Factor (RTF)[^2] | 0.085                                | 0.2                                  | 0.034                                     | 0.120                                     | 0.018                                      |
| Job Concurrency                           | 20                                   | 20                                   | 15[^3]                                    | 6[^3]                                     | 70[^3]                                     |
=======
...
| Cost vs CPU Enhanced (%)                   | 45%          | -            | 9%           | 44%          |
| Maximum Throughput[^1]                     | 53.2         | 23.7         | 350          | 45           |
| Representative Real-Time Factor (RTF)[^2]  | 0.085        | 0.2          | 0.034        | 0.120        |
| Job Concurrency                            | 20           | 20           | 15[^3]       | 6[^3]        |
...
The results above were measured with diarization disabled.
:::


### Realtime transcription

| Models                                     | [CPU Standard](./cpu-speech-to-text#realtime-transcription) | [CPU Enhanced](./cpu-speech-to-text#realtime-transcription) | [GPU Standard](./gpu-speech-to-text#batch-and-realtime-inference) | [GPU Enhanced](./gpu-speech-to-text#batch-and-realtime-inference) |
|--------------------------------------------|--------------|--------------|--------------|--------------|
...
[^3]: Multiple jobs (batch mode) or sessions (Realtime mode) are handled by a single worker configured with the required concurrency.
...
[Translation](./gpu-translation) running on a 4-core T4 has an RTF of roughly 0.008. It can handle up to 125 hours of batch audio per hour, or 125 Realtime Transcription streams. However, each translation target language is counted as a stream, meaning that a single Realtime Transcription stream which requests 5 target languages adds the same load on the Translation Inference Server as 5 transcription streams each requesting a single target language.
