...
| Models                                    | [CPU Standard](./cpu-speech-to-text) | [CPU Enhanced](./cpu-speech-to-text) | [GPU Standard](./gpu-speech-to-text) | [GPU Enhanced](./gpu-speech-to-text) | [GPU Melia 1](./gpu-speech-to-text-melia-1) |
|-------------------------------------------|--------------------------------------|--------------------------------------|--------------------------------------|--------------------------------------|---------------------------------------------|
| Lowest Processing Cost (US ¢ per hour)    | 1.7                                  | 3.8                                  | 0.34                                 | 1.67                                 | 0.19                                        |
| Cost vs CPU Standard (%)                  | -                                    | 224%                                 | 20%                                  | 98%                                  | 11%                                         |
| Cost vs CPU Enhanced (%)                  | 45%                                  | -                                    | 9%                                   | 44%                                  | 5%                                          |
| Cost vs GPU Standard (%)                  | 500%                                 | 1118%                                | -                                    | 491%                                 | 56%                                         |
| Cost vs GPU Enhanced (%)                  | 102%                                 | 228%                                 | 20%                                  | -                                    | 11%                                         |
...
The Batch transcription results above were measured with diarization disabled.
:::
...
The RT transcription results above were measured with diarization disabled.
:::
