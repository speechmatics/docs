...
|--------------------------------------------|--------------|--------------|--------------|--------------|
| Lowest Processing Cost (US ¢ per hour)     | 1.7          | 3.8          | 0.34         | 1.88         |
| Cost vs CPU Standard (%)                   | -            | 224%         | 20%          | 110%         |
| Cost vs CPU Enhanced (%)                   | 45%          | -            | 9%           | 49%          |
| Maximum Throughput[^1]                     | 53.2         | 23.7         | 350          | 40           |
| Representative Real-Time Factor (RTF)[^2]  | 0.085        | 0.2          | 0.034        | 0.127        |
