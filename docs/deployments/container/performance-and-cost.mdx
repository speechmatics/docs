...
|--------------------------------------------|--------------|--------------|--------------|--------------|
| Lowest Processing Cost (US ¢ per hour)     | 1.7          | 3.8          | 0.33         | 1.88         |
| Cost vs CPU Standard (%)                   | -            | 224%         | 19%          | 110%         |
| Cost vs CPU Enhanced (%)                   | 45%          | -            | 9%           | 49%          |
| Maximum Throughput[^1]                     | 53.2         | 23.7         | 360          | 40           |
| Representative Real-Time Factor (RTF)[^2]  | 0.085        | 0.2          | 0.04         | 0.127        |
| Job Concurrency                            | 20           | 20           | 16[^3]       | 6[^3]        |
