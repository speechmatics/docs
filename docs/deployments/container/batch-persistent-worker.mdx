...
The API is made on purpose similar to our [V2 SaaS API](/api-ref/batch/create-a-new-job) to ease integration to our SaaS, and be able to use both SaaS and On-prem interchangeably.
There are some difference between the SaaS vs On-prem API outlined below:

#### For the Batch persistent worker:
