...
Instead of uploading the audio file directly, you can have the worker fetch it from a remote URL by adding a `fetch_data` section to the job config. See [Fetch URL](/speech-to-text/batch/input#fetch-url) for the full configuration reference.
