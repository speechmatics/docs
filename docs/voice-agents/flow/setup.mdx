---
sidebar_label: Setup
description: 'Learn about the setup for Flow'
---

import SchemaNode from "@theme/Schema";
import flowSchema from "!openapi-schema-loader!@site/spec/flow-api.yaml";
...
<SchemaNode schema={flowSchema.components.schemas.ConversationConfig} />
...
### Moderating and controlling conversations
