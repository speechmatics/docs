...
The SpeechmaticsSTTService requires an API key. You can generate your API key in the [Speechmatics Portal](https://portal.speechmatics.com/settings/api-keys).
