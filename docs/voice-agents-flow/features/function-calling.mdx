---
description: 'Learn about the function calling feature for Flow'
---
...
[Create an agent in the portal](https://portal.speechmatics.com/create-agent) and enable function calling in the agent settings.
