...
When starting a Real-Time transcription session **in the browser**, [temporary keys](/get-started/authentication) should be used to avoid exposing your long-lived API key.
