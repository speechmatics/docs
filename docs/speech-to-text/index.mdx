...
Choose between two accuracy models when configuring your Realtime session:
...
- **Standard** — optimized for faster turnaround with strong accuracy; ideal for compliance workflows and routine file-based transcription
