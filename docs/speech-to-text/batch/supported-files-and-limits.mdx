...
* For Real-time transcription, see the [Real-time Transcription supported formats and limits](/speech-to-text/real-time/supported-formats-and-limits).
...
To process files larger than 1 GB, you can provide the URL of the audio file in the job config as described in the [Fetch URL documentation](/speech-to-text/batch/fetch-url).
