...
The tracking information will be returned when you [check job status](/speech-to-text/batch/output), or [get the transcript](/api-ref/batch/get-the-transcript-for-a-transcription-job) for a transcription job.
