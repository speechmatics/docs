...
Checking status of Alignment jobs is done in the same way as transcription jobs. This is described on [this page](/speech-to-text/batch/check-job-status).
...
Note that Alignment follows Speechmatics' [Data Retention Limits](/speech-to-text/batch/supported-files-and-limits#data-retention-limits).
