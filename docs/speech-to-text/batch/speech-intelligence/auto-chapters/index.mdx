...
- Chapters works best with Speaker or Channel [Diarization](/speech-to-text/output-enhancements/diarization) enabled
- Punctuation plays a significant role in the quality of the Chapters. It is therefore recommended to avoid disabling any end of sentence [Punctuation Marks](/speech-to-text/formatting#punctuation-settings) or reducing the [Punctuation Sensitivity](/speech-to-text/formatting#punctuation-settings)
...
Chapters is supported for [all of Speechmatics' languages](/speech-to-text/supported-languages) except Irish, Maltese, Urdu, Bengali and Swahili.
