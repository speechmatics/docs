...
:::note
The Melia 1 model does not support `language: auto` and returns an error. Melia 1 is multilingual and detects languages automatically without it. Refer to [Models](/speech-to-text/models).
:::
