...
[Output Locale](/speech-to-text/formatting#output-formatting-options#output-locale) is currently not supported in combination with using Automatic Language Identification. Jobs with this combination of features will be rejected.
