...
If you're new to Speechmatics, please see our guide on [Transcribing a File](/speech-to-text/pre-recorded/quickstart). Once you are set up, include the following config to enable Topics:
...
Topics are available with the Standard and Enhanced models for pre-recorded transcription on SaaS on Cloud. See [Feature availability](/speech-to-text/availability/).
