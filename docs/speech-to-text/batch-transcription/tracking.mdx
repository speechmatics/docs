...
The tracking information will be returned when you [check job status](/speech-to-text/batch-transcription/check-job-status), or [get the transcript](/api-ref/batch/get-the-transcript-for-a-transcription-job) for a transcription job.
