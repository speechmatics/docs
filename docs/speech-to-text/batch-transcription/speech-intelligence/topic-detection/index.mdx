...
If you're new to Speechmatics, please see our guide on [Transcribing a File](/speech-to-text/batch-transcription/quickstart). Once you are set up, include the following config to enable Topics:
