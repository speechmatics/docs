...
- Punctuation plays a significant role in the quality of the Chapters. It is therefore recommended to avoid disabling any end of sentence [Punctuation Marks](https://docs.speechmatics.com/features/punctuation-settings) or reducing the [Punctuation Sensitivity](https://docs.speechmatics.com/features/punctuation-settings)
