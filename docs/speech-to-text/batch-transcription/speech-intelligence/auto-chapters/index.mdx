...
If you're new to Speechmatics, please see our guide on [Transcribing a File](/speech-to-text/batch-transcription/quickstart). Once you are set up, include the following config to enable Chapters:
...
- Punctuation plays a significant role in the quality of the Chapters. It is therefore recommended to avoid disabling any end of sentence [Punctuation Marks](/features/punctuation-settings) or reducing the [Punctuation Sensitivity](/features/punctuation-settings)
