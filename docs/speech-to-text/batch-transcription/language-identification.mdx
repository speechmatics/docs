...
If you're new to Speechmatics, please see our guide on [Transcribing a File](/speech-to-text/batch-transcription/quickstart) through our API.
...
A list of possible [Language Codes can be found here](/speech-to-text/supported-languages). The following languages are not supported for Language Identification: Interlingua (ia), Esperanto (eo), Uyghur (ug), Cantonese (yue), Irish (ga), Maltese (mt), Urdu (ur), Bengali (bn), Swahili (sw).
...
When getting [Job Details](https://docs.speechmatics.com/jobsapi#tag/jobs/paths/~1jobs~1%7Bjobid%7D/get) or [Transcript](https://docs.speechmatics.com/jobsapi#tag/jobs/paths/~1jobs~1%7Bjobid%7D~1transcript/get), the job will succeed and you will see an error message in the job metadata:
...
[Output Locale](/speech-to-text/features/accuracy-language-packs#output-locale) is currently not supported in combination with using Automatic Language Identification. Jobs with this combination of features will be rejected.
...
Language ID is supported for [all of Speechmatics' languages](/speech-to-text/supported-languages) except Interlingua (ia), Esperanto (eo), Uyghur (ug), Cantonese (yue), Irish (ga), Maltese (mt), Urdu (ur), Bengali (bn), Swahili (sw).
...
This error is available when checking the [job details](https://docs.speechmatics.com/jobsapi#tag/jobs/paths/~1jobs~1%7Bjobid%7D/get):
...
These errors are available when getting the [job transcript](https://docs.speechmatics.com/jobsapi#tag/jobs/paths/~1jobs~1%7Bjobid%7D~1transcript/get):
