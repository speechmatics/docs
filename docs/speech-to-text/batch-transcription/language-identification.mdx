...
When getting [Job Details](/jobsapi#tag/jobs/paths/~1jobs~1%7Bjobid%7D/get) or [Transcript](/jobsapi#tag/jobs/paths/~1jobs~1%7Bjobid%7D~1transcript/get), the job will succeed and you will see an error message in the job metadata:
...
This error is available when checking the [job details](/jobsapi#tag/jobs/paths/~1jobs~1%7Bjobid%7D/get):
...
These errors are available when getting the [job transcript](/jobsapi#tag/jobs/paths/~1jobs~1%7Bjobid%7D~1transcript/get):
