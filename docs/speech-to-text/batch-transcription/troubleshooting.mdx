...
## Terminating jobs
If you want to terminate a job that is in progress, you can use the [Delete endpoint](/api-ref/batch/delete-a-job) with the `force` parameter. This could be helpful if job seems stuck, too long running, or the output is no longer needed.
