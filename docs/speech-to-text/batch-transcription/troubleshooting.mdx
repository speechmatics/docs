...
## Terminating jobs
If you want to terminate a job that is in progress, you can use the [Delete endpoint](https://docs.speechmatics.com/jobsapi#tag/jobs/paths/~1jobs~1%7Bjobid%7D/delete) with the `force` parameter. This could be helpful if job seems stuck, too long running, or the output is no longer needed.
