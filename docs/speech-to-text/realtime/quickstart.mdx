...
:::info
Looking for the raw WebSocket protocol? See our [WebSocket protocol guide](/speech-to-text/realtime/guides/websocket-protocol) for a language-agnostic walkthrough.
:::
