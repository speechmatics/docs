...
When this message is received, the server will send a [Final](../../api-ref/realtime-transcription-websocket#addtranscript) transcript message, followed by an extra [EndOfUtterance](../../api-ref/realtime-transcription-websocket#endofutterance) message.
