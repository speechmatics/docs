...
Once this happens, the channel will stop accepting or processing any additional data. When all channels are closed, the session ends - similar to [EndOfStream](../../api-ref/realtime-transcription-websocket#endofstream).
