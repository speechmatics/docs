...
You can also use [EndOfStream](../../api-ref/realtime-transcription-websocket#endofstream) to simultaneously close all channels.

At this time, closing a channel does not affect pricing for On-Prem or SaaS deployments, but we’re actively working to make that possible in the future.
