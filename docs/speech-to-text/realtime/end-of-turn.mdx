...
If you have your own VAD or end of turn model, you can request a finalised transcript of any unprocessed audio you've sent by sending a `ForceEndOfUtterance` message:
...
This can also be requested when using multichannel:
...
You'll receive an [AddTranscript](../../api-ref/realtime-transcription-websocket#addtranscript) message followed immediately by an [EndOfUtterance](../../api-ref/realtime-transcription-websocket#endofutterance) message.

This is great for when you want to manage your transcript closely and trim it in sync with the input audio.
