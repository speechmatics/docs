...
Forcing an end of turn allows you to manually trigger an end-of-turn detection at any point in the conversation. This is done by sending a `ForceEndOfTurn` message:

```json
{
  "message": "ForceEndOfTurn"
}
```

If you have your own end of turn detection model, you can integrate it with our ASR by sending the `ForceEndOfTurn` message when your model detects an end of turn.
