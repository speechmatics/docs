...
<Grid columns={{initial: "1", md: "2"}} gap="3">
  <LinkCard
    ...
    href="/speech-to-text/pre-recorded/batch-diarization"
    icon={<Users/>}
  />
  <LinkCard
  ...
  <LinkCard
    ...
    href="/speech-to-text/pre-recorded/speech-intelligence/summarization"
    icon={<Sparkles/>}
  />
  <LinkCard
    title="Sentiment Analysis"
    description="Detect the sentiment and emotional tone within your transcripts"
    href="/speech-to-text/pre-recorded/speech-intelligence/sentiment-analysis"
    icon={<BarChart2/>}
  />
  <LinkCard
    title="Auto Chapters"
    description="Segment long transcripts into meaningful, titled chapters"
    href="/speech-to-text/pre-recorded/speech-intelligence/auto-chapters"
    icon={<Layers/>}
  />
  <LinkCard
    title="Translation"
