...
The Melia 1 model detects every language it hears automatically. To bias detection toward languages you expect, see [Mixed-language transcription](/speech-to-text/features/mixed-language-transcription#language-hints).
