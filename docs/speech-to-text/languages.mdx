...
Speechmatics offers industry-leading accuracy in the healthcare domain when using the default `enhanced` [operating point](#operating-points). For customers working exclusively in the healthcare domain, we recommend using the medical domain-specific model. 
