...
**Languages:** all supported languages. Disfluency detection is available for the [supported languages](/speech-to-text/features/disfluencies-and-profanities#supported-languages-for-disfluencies); other languages fall back to speech-rate adaptation.
