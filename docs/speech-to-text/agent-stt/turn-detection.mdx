...
The service runs voice activity detection over the audio and closes the turn when speech stops. Nothing is required from your application beyond streaming audio, and `ForceEndOfUtterance` is ignored.
