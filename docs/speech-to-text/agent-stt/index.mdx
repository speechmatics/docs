...
- **Intelligent segmentation**: group words into clean, speaker-attributed segments. See [Segmentation](/speech-to-text/agent-stt/segmentation).
...
Use the global endpoint to route to the nearest region, or pin to a region for data residency. See [Supported endpoints](/get-started/authentication#supported-endpoints) for regional endpoints.
