...
- **Turn detection**: detect when a speaker has finished talking. See [Turn detection](/speech-to-text/agent-stt/turn-detection).
- **Intelligent segmentation**: group partial transcripts into clean, speaker-attributed segments. See [Segmentation](/speech-to-text/agent-stt/segmentation).
