...
For the full list of Batch endpoints, refer to [Authentication](https://docs.speechmatics.com/get-started/authentication#supported-endpoints).
...
To configure language hints and read the per-language output metadata, refer to [Input](https://docs.speechmatics.com/speech-to-text/batch/input) and [Output](https://docs.speechmatics.com/speech-to-text/batch/output).
