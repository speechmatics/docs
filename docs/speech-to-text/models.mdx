...
| Language handling | [Selected language or pack](/speech-to-text/languages) ([auto-detect](/speech-to-text/batch/language-identification) available) | [Selected language or pack](/speech-to-text/languages) ([auto-detect](/speech-to-text/batch/language-identification) available) | [Automatic multilingual](/speech-to-text/batch/input#multilingual-transcription-with-melia-1) |
...
To configure language hints and read the per-language output metadata, refer to [Input](/speech-to-text/batch/input#multilingual-transcription-with-melia-1) and [Output](/speech-to-text/batch/output#multilingual-transcript-output).
