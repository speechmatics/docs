...
- **Formatting:** The translation is applied to the [written form](/speech-to-text/output-enhancements/numerical-formatting) transcript
...
If you want to report an issue or get Support more urgently [Raise an Issue](/speech-to-text/batch-transcription/troubleshooting) instead.
