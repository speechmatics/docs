...
If you're new to Speechmatics, start by exploring our guides on [Transcribing a File](/speech-to-text/batch-transcription/quickstart) or [Transcribing in Real-Time](/speech-to-text/real-time-transcription/quickstart). 
