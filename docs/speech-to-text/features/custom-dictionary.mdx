...
On-prem Real-Time Containers can also make use of a [Shared Custom Dictionary Cache](/deployments/container/cpu-speech-to-text-container.mdx#how-to-use-a-shared-custom-dictionary-cache).