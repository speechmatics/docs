...
Any elements that surpass this limit will be dropped before transcription starts, with a in-band warning message of type `validation_warning` sent to the client.
