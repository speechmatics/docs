...
- `metadata`
    - `language_pack_info` - For each of our [supported languages](/speech-to-text/supported-languages), give the full name of the language, as well as any [Domain Language Optimizations](../features/accuracy-language-packs.mdx#domain-language-optimization) or [Output Locales](../features/word-tagging.mdx#output-locale)
- `batch` - Capabilities relating to our Batch API
    ...
    - `languageid` - List of languages supported by [Language Identification](/speech-to-text/features/language-identification)
