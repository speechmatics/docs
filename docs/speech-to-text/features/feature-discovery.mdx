...
- `metadata`
    - `language_pack_info` - For each of our [supported languages](/speech-to-text/languages), give the full name of the language, as well as any [Domain Language Optimizations](/speech-to-text/features/accuracy-language-packs#domain-language-optimization) or [Output Locales](/speech-to-text/formatting#output-formatting-options#output-locale)
