...
:::warning
In streaming, the `channel` property is returned for `AddTranscript` and `AddPartialTranscript` messages only. The [translation](/speech-to-text/features/translation) add-on does not currently include this property. To request it, contact [Support](https://support.speechmatics.com).
:::
