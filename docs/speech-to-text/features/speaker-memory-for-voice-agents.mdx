...
To use them, pass them as known speakers when you open the next session. Each entry pairs a label (now a real name) with the list of identifiers you saved.
