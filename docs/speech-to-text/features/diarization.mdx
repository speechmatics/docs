...
Realtime channel diarization is useful for remote conference calls, where separate audio streams may include multiple speakers.  
...
You'll get an acknowledgement in the form of a `ChannelAudioAdded` message from the server:
