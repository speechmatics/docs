...
The following languages can be translated to and from **English** in real time and batch:
...
:::tip
In batch, you can also translate from Norwegian Bokmål (no) to Nynorsk (nn).
:::
