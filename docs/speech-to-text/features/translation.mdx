...
- `language`: Real-time only. The translated language [ISO Language Code](/speech-to-text/languages#languages)
...
- **Punctuation:** Punctuation plays a significant role in the accuracy of translation. It is therefore recommended to avoid disabling any [Punctuation Marks](/speech-to-text/formatting#punctuation-settings) or reducing the [Punctuation Sensitivity](/speech-to-text/formatting#punctuation-settings) to ensure the best possible results
- **Formatting:** The translation is applied to the [written form](/speech-to-text/formatting#numeral-formatting) transcript
