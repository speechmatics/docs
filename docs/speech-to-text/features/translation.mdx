...
New to Speechmatics? See our guides on [transcribing a file](/speech-to-text/batch/quickstart) or [transcribing in real-time](/speech-to-text/realtime/quickstart). Once set up, add the following configuration to enable translation:
...
Python client example to translate a file in real-time, see [here](/speech-to-text/realtime/quickstart) for more examples of Realtime Transcription
