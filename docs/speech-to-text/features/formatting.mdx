...
:::warning
Disabling punctuation may slightly reduce speaker diarization accuracy. See [speaker diarization](/speech-to-text/features/speaker-diarization) for details.
:::
