...
:::info
The `channel` fields are only returned when [channel](../../speech-to-text/streaming/realtime-diarization#channel-diarization) or [`channel and speaker`](../../speech-to-text/streaming/realtime-diarization#channel-and-speaker-diarization) diarization is enabled.
