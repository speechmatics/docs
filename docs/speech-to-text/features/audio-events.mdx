...
If you're new to Speechmatics, start by exploring our guides on [Processing a File](/speech-to-text/batch/quickstart) or [Analyzing in Real-Time](/speech-to-text/real-time/quickstart). To activate Audio Events, include the following configuration:  
...
Python client example for detecting Audio Events in real-time, see [here](/speech-to-text/real-time/quickstart) for more examples of Real-Time Transcription 
