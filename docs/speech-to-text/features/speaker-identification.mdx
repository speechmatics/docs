...
On an on-prem deployment, batch speaker identification requires the [GPU speech-to-text container](/deployments/container/gpu-speech-to-text) and you must [manage speaker identification secrets](/deployments/container/speaker-identification) yourself. Both are handled for you on SaaS.
