...
- When transcribing in Real-Time, [Partial transcripts](/speech-to-text/real-time/real-time-latency#partial-transcripts) will not include speaker information.
