...
| -------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------- |
| [Speaker Diarization](#speaker-diarization) | Each speaker will be identified by their voice.                                            | Used in cases where there are multiple speakers in the same audio recording. |
| [Channel Diarization](#channel-diarization) | Each audio channel will be transcribed separately. Available for batch transcription only. | Used when it's possible to record each speaker on a separate audio channel.  |
...
- When transcribing in Real-Time, [Partial transcripts](./realtime-latency.mdx#partial-transcripts) will not include speaker information.
...
:::note
This feature is only available for [Batch Transcription](/speech-to-text/batch-transcription).
:::
...
{/* <FeatureAvailability modes={['Batch']} deployments={['All']}/> */}
