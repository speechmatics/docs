...
- When transcribing in Real-Time, [Partial transcripts](/speech-to-text/real-time-transcription/real-time-latency#partial-transcripts) will not include speaker information.
