...
:::warning
Disabling punctuation may slightly harm the accuracy of Speaker Diarization. Please see the [Speaker Diarization and Punctuation](./diarization.mdx#speaker-diarization-and-punctuation) section in the docs for more information.
:::
