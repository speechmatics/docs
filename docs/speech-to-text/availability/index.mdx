...
{/* App usage tracking is absent from the streaming table in feature-availability.md,
    ...
    WebSocket URL, so it is published here and a catalogue correction has been raised. */}
...
{/* Entity detection (basic, legacy), audio filtering, and force end of utterance are marked
    ...
    shipped configuration on the /v2/agent endpoints. Published here; catalogue corrections
    raised. */}
