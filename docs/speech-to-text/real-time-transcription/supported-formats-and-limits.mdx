...
sidebar_label: 'Supported Formats and Limits'
...
# Supported Formats and Limits (Real-time)

:::info
This page documents limits, conditions and supported audio formats the **Real-time transcription API** (websocket).
