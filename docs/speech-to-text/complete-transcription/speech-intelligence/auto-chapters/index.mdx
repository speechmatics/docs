...
If you're new to Speechmatics, please see our guide on [Transcribing a File](/speech-to-text/complete-transcription/quickstart). Once you are set up, include the following config to enable Chapters:
...
- Chapters works best with Speaker or Channel [Diarization](../features/diarization.mdx) enabled
...
Chapters is supported for [all of Speechmatics' languages](../introduction/supported-languages.mdx) except Irish, Maltese, Urdu, Bengali and Swahili.
