...
View our guides: 
- [using a microphone](/speech-to-text/streaming/guides/python-using-microphone) to learn how to capture audio from a microphone. 
- [using FFMPEG](/speech-to-text/streaming/guides/python-using-ffmpeg) to find out how to pipe microphone audio to the API.