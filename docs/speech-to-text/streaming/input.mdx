...
To capture audio from a microphone, see the [Quickstart](/speech-to-text/streaming/quickstart). To pipe audio from another source, see [Pipe audio from FFmpeg](/speech-to-text/streaming/ffmpeg-audio).
