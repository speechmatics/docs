...
The Realtime API streams audio over a WebSocket connection and returns transcript results as you speak. Unlike the [Batch API](/speech-to-text/pre-recorded/quickstart), results arrive continuously — within milliseconds of the spoken words.
...
<Tabs groupId="language">
  ...
  ```
  :::note
  `pyaudio` is required for microphone input in this quickstart. On Mac M1 and M2, install it with:
  ```bash
