...
Translation is supported for most Speechmatics languages, with the supported translation pairs listed below. For how to configure it, see [Translation](/speech-to-text/add-ons/translation).
