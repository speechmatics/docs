...
:::warning[Deprecated]
The Voice SDK is deprecated and replaced by [Agent STT](/speech-to-text/agent-stt), which provides turn detection, segmentation and diarization as part of the API rather than in a client library.

Start new projects with the [Agent STT quickstart](/speech-to-text/agent-stt/quickstart). This page remains for existing integrations.
:::
