...
description: Transcribe live Twilio Voice calls with Speechmatics Realtime using a small, forkable proxy server.
---
...
Open `.env` in your editor and set the environment variables. The proxy won't run if any are missing.
...
- [Read the Realtime API reference](/api-ref/realtime-transcription-websocket)
