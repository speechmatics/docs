---
id: integrations-and-sdks/sdks/stt-sdk/python/rt-stt-python
description: Learn how to use the Speechmatics Real-time API Client in Python
---

# Speechmatics Real-time API Client in Python
