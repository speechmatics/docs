...
- **Translation**: Realtime transcription of live events or recordings
...
- LiveKit >= 1.2
- Speechmatics API key. You can generate one [here](https://portal.speechmatics.com/settings/api-key).
