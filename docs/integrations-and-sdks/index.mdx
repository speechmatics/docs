---
title: Integrations and SDKs — Overview
description: Discover which integrations and SDKs add Speechmatics Speech to Text and Text to Speech to your applications.
---
...
Choose an integration to build voice agents on the Speechmatics API, available in these frameworks.
...
<Grid columns="3" gap="3">
  <LinkCard
    title="Zapier"
    description="Transcribe audio inside Zaps. Trigger from any app, send transcripts to any downstream step. Best for: no-code automation."
    icon={<img src="/img/integration-logos/zapier.png" alt="Zapier logo" width="28px" height="28px" />}
...
<Grid columns="3" gap="3">
  <LinkCard
    ...
    description="Segment transcripts and detect turns for LLM workflows"
    icon={<DevIcon name="python" />}
    href="/integrations-and-sdks/voice-sdk/"
  />
   <LinkCard
